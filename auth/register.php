...
<div class="max-w-4xl mx-auto bg-white rounded-3xl border border-sky-100/60 shadow-xl overflow-hidden min-h-[550px] flex flex-col md:flex-row">
    ...
    <!-- RIGHT SIDE: REGISTER FORM CONSOLE -->
    <div class="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
        ...
        <form method="POST" class="space-y-4">
            ...
            <button type="submit"
                    class="w-full bg-sky-500 hover:bg-sky-600 text-white font-semibold py-3 rounded-xl shadow-md hover:shadow-lg transition duration-200 text-sm mt-2">
                Register Account
            </button>
        </form>
        ...
        <p class="mt-6 text-center text-sm text-slate-500">
            ...
            <a href="/PawTrack/auth/login.php" class="text-sky-600 font-semibold hover:underline">Login here</a>
        </p>
    </div>
</div>
