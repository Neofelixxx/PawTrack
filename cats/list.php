                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-2 mt-2 pt-3 border-t border-slate-100 text-xs text-slate-700">
                            <div class="flex items-center">
                                <p class="text-slate-800"><b class="text-slate-900 font-bold">Age Group:</b> <?php echo htmlspecialchars($row['agecategory']); ?></p>
                            </div>
                            <div class="flex items-center">
                                <p class="text-slate-800"><b class="text-slate-900 font-bold">Shelter:</b> <?php echo htmlspecialchars($row['sheltername']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
