                ...
                <div class="bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-white/40 shadow-sm">
                    ...
                    <form method="POST" action="/PawTrack/donations/add.php" class="space-y-4 text-xs">
                        ...
                        <div>
                            ...
                            <select name="type" id="donationType" onchange="toggleUnifiedFields()" class="w-full bg-white border border-slate-200 p-3 rounded-xl focus:outline-none focus:border-sky-400 text-sm font-semibold text-slate-700">
                        ...
                        <div id="financialInputs">
                            ...
                            <input type="number" step="0.01" name="amount" id="amountField" placeholder="0.00" class="w-full bg-white border border-slate-200 p-3 rounded-xl focus:outline-none focus:border-sky-400 text-sm font-mono">
                        </div>
                        ...
                        <div id="materialInputs" class="hidden space-y-3">
                            <div>
                                ...
                                <input type="text" name="item" id="itemField" placeholder="e.g. Tofu Litter, Cages" class="w-full bg-white border border-slate-200 p-3 rounded-xl focus:outline-none focus:border-sky-400 text-sm">
                            </div>
                            <div>
                                <label class="block font-bold text-slate-400 uppercase tracking-wider mb-1">Quantity Units</label>
                                <input type="number" name="quantity" id="qtyField" placeholder="1" class="w-full bg-white border border-slate-200 p-3 rounded-xl focus:outline-none focus:border-sky-400 text-sm font-mono">
                            </div>
                        </div>
